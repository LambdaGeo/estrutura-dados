...
### 2️⃣ **Verificar Palíndromo (Palavra)**
...
### 3️⃣ **Verificar Palíndromo (Frase)**
...
### 5️⃣ **Contar Quantidade de Cada Vogal**
...
### 6️⃣ **Criptografia por Substituição (Cifra de César)**
...
### 7️⃣ **Contar Ocorrência de um Caractere**
...
### 9️⃣ **Converter String para Maiúsculas**
